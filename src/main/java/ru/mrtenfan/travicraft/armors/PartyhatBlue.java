...
public class PartyhatBlue extends ItemArmor {

	public PartyhatBlue(int id, int armorType) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		return "travicraft:textures/models/armors/partyhat3.png";     //текстурка брони на игроке
	}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving,
		...
		if(itemStack != null){
			if(itemStack.getItem() instanceof PartyhatBlue){
